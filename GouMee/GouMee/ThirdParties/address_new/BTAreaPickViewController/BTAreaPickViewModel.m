...
- (instancetype)init{
    ...
    if (self) {
        ...
        self.selectedCitie = self.selectedProvince.cityList.firstObject;
        self.selectedArea = self.selectedCitie.areaList.firstObject;
    }
    return self;
}
