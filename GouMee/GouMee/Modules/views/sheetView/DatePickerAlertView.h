...
#define D_yyyyMMddHHmm      @"yyyyMMdd E HH:mm"         //时间标准模式——2.年-月-日 小时:分钟
...
/**
 ...
 @param selectCompletion 完成回调
 */
+ (void)showDatePickerAlertViewWithDateFormat:(NSString *)dateFormat datePickerMode:(UIDatePickerMode)datePickerMode selectCompletion:(void (^)(NSDate *fromDate, NSDate *toDate))selectCompletion withTime:(NSDate *)currentTime;
/**
 日期转换
