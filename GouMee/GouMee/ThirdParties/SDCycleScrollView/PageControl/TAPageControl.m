...
{
    return CGSizeMake((self.dotSize.width) * pageCount , self.dotSize.height);
}
...
- (void)updateDotFrame:(UIView *)dot atIndex:(NSInteger)index
{
    ...
    CGFloat x = (self.dotSize.width ) * index + ( (CGRectGetWidth(self.frame) - [self sizeForNumberOfPages:self.numberOfPages].width) / 2);
