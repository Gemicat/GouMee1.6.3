...
- (void)createInterface {
    // 图片
    self.leftIV = [UIImageView initImageView:@""];
    ...
    [self.deleteBtn setImage:GetImage(@"delete_bg") forState:UIControlStateNormal];
    self.deleteBtn.frame = CGRectMake(self.width - 60, 5, 40, self.height);
